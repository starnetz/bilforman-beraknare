...
export async function GET() {
  try {
    ...
    // Hämta raw text istället för att tolka som JSON
    const data = await response.text();
    console.log('SCB API svar längd:', data.length);
    console.log('SCB API svar början:', data.substring(0, 200));
    
    // Returnera direkt som text
